...
class ModMenuCombat : ModMenuApi {
    override fun getModConfigScreenFactory(): ConfigScreenFactory<*> {
        return ConfigScreenFactory {
            ...
            customizationCategory.addEntry(entryBuilder
                .startBooleanToggle(
                    Text.translatable("config.${HydraMod.MODID}.customization.enable_cache"),
                    config.enableCache
                )
                .setSaveConsumer {  config.enableCache = it }
                .setTooltip(Text.translatable("config.${HydraMod.MODID}.customization.enable_cache.tooltip"))
